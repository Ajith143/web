                                                    ...
                                                    <div class="product--quantity-wrapper">
                                                        ...
                                                        <div class="product--quantity" data-trigger="spinner">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="material_name" value="3" data-min="1" data-max="10" data-step="1" class="form-control" data-rule="material_name">
                                                    ...
                                                    <div class="product--quantity-wrapper">
                                                        ...
                                                        <div class="product--quantity" data-trigger="spinner">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="quantity" value="3" data-min="1" data-max="10" data-step="1" class="form-control" data-rule="quantity">
                                ...
                                <div class="col-md-6 pb--60">
                                    ...
                                    <div class="cart--coupon" data-form="validate">
                                        <div class="cart--title bg-lighter">
                                            <h3 class="h4">Discount Coupon</h3>
                                        </div>
