...
<!-- Mirrored from themelooks.us/demo/socifly/html/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2017 13:47:40 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="banner--content pt--70 pb--80 text-center">
                                            <div class="title">
                                                <h1 class="h1 text-lightgray">Welcome To Engineering World</h1>
                                            </div>
                                            ...
                                            <div class="action text-uppercase">
                                                ...
                                                <a href="#" class="btn btn-primary">See Members</a>                                            </div>
                                        </div>
                                        <!-- Banner Content End -->
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="banner--content pt--70 pb--80 text-center">
                                            <div class="title">
                                                <h1 class="h1 text-lightgray">Welcome To Nandha InfoTech</h1>
                                            </div>
                    ...
                    <div class="col-md-7 pb--40">
                        <div class="row gutter--15 AdjustRow" data-scroll-reveal="group">
                            <div class="col-xs-4 pb--15">
                                <img src="img/how-it-works-img/01.jpg" alt="">                            </div>

                            <div class="col-xs-4 pb--15">
                                <img src="img/how-it-works-img/02.jpg" alt="">                            </div>

                            <div class="col-xs-4 pb--15">
                                <img src="img/how-it-works-img/03.jpg" alt="">                            </div>

                            <div class="col-xs-12">
                                <img src="img/how-it-works-img/04.jpg" alt="">                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 pb--40">
                        ...
                        <div class="info--items" data-scroll-reveal="group">
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="img/how-it-works-img/icon-01.png" alt="">                                </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="img/how-it-works-img/icon-02.png" alt="">                                </div>

                                <div class="info">
                                    <div class="title">
                                        <h3 class="h4 fw--700">Share your Knowledge</h3>
                                    </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="img/how-it-works-img/icon-03.png" alt="">                                </div>
                            ...
                            <div class="info--item clearfix">
                                <div class="icon">
                                    <img src="img/how-it-works-img/icon-04.png" alt="">                                </div>
                                    ...
                                    <div class="vc--child">
                                        <div class="img img-circle">
                                            <a href="member-activity-personal.html" class="btn-link">
                                                <img src="img/members-img/member-01.jpg" alt="">                                            </a>                                        </div>

                                        <div class="name">
                                            <h3 class="h6 fs--12">
                                                <a href="member-activity-personal.html" class="btn-link">Rosa R. Secor</a>                                            </h3>
                                        </div>
                            ...
                            <div class="member--item">
                                <div class="vc--parent">
                                    <div class="vc--child">
                                        <div class="img img-circle">
                                            <a href="member-activity-personal.html" class="btn-link">
                                                <img src="img/members-img/member-02.jpg" alt="">                                            </a>                                        </div>

                                        <div class="name">
                                            <h3 class="h6 fs--12">
                                                <a href="member-activity-personal.html" class="btn-link">Juan Bishop</a>                                            </h3>
                                        </div>
                            ...
                            <div class="member--item online">
                                <div class="vc--parent">
                                    <div class="vc--child">
                                        <div class="img img-circle">
                                            <a href="member-activity-personal.html" class="btn-link">
                                                <img src="img/members-img/member-03.jpg" alt="">                                            </a>                                        </div>

                                        <div class="name">
                                            <h3 class="h6 fs--12">
                                                <a href="member-activity-personal.html" class="btn-link">Kelly Salazar</a>                                            </h3>
                                        </div>
                            ...
                            <div class="member--item online">
                                <div class="vc--parent">
                                    <div class="vc--child">
                                        <div class="img img-circle">
                                            <a href="member-activity-personal.html" class="btn-link">
                                                <img src="img/members-img/member-04.jpg" alt="">                                            </a>                                        </div>

                                        <div class="name">
                                            <h3 class="h6 fs--12">
                                                <a href="member-activity-personal.html" class="btn-link">Gregory L. Caudill</a>                                            </h3>
                                        </div>
                            ...
                            <div class="member--item">
                                <div class="vc--parent">
                                    <div class="vc--child">
                                        <div class="img img-circle">
                                            <a href="member-activity-personal.html" class="btn-link">
                                                <img src="img/members-img/member-05.jpg" alt="">                                            </a>                                        </div>

                                        <div class="name">
                                            <h3 class="h6 fs--12">
                                                <a href="member-activity-personal.html" class="btn-link">William P. Waite</a>                                            </h3>
                                        </div>
                        ...
                        <div class="testimonial--items owl-carousel" data-owl-dots="true" data-owl-margin="10" data-owl-autoplay="false" data-owl-animate="fadeOut">
                            ...
                            <div class="testimonial--item clearfix">
                                <div class="img mr--20 float--left">
                                    <img src="img/testimonial-img/01.jpg" alt="">                                </div>
                            ...
                            <div class="testimonial--item clearfix">
                                <div class="img mr--20 float--left">
                                    <img src="img/testimonial-img/02.jpg" alt="">                                </div>
                            ...
                            <div class="testimonial--item clearfix">
                                <div class="img mr--20 float--left">
                                    <img src="img/testimonial-img/03.jpg" alt="">                                </div>
                    ...
                    <div class="col-md-6 pb--60">
                        ...
                        <div class="video--popup style--1" data-overlay="0.3">
                            ...
                            <a href="https://www.youtube.com/watch?v=YE7VzlLtp-4" class="btn-link" data-trigger="video_popup">
                                <span><i class="fa fa-play"></i></span>                            </a>                        </div>
                        <!-- Video Popup End -->
                    </div>
                </div>
            </div>
                                ...
                                <div class="title">
                                    <h3 class="h6 fw--700 text-darker">
                                        <a href="#faqItem01" data-parent="#faqItems" data-toggle="collapse" class="collapsed">
                                            <span>How can I register?</span>                                        </a>                                    </h3>
                                </div>
                                ...
                                <div class="title">
                                    <h3 class="h6 fw--700 text-darker">
                                        <a href="#faqItem02" data-parent="#faqItems" data-toggle="collapse" class="collapsed">
                                            <span>What are the benefits of premium plans?</span>                                        </a>                                    </h3>
                                </div>
                                ...
                                <div class="title">
                                    <h3 class="h6 fw--700 text-darker">
                                        <a href="#faqItem03" data-parent="#faqItems" data-toggle="collapse" class="collapsed">
                                            <span>How can I renew my plan?</span>                                        </a>                                    </h3>
                                </div>
...
<!-- Mirrored from themelooks.us/demo/socifly/html/home-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Dec 2017 13:48:06 GMT -->
</html>
